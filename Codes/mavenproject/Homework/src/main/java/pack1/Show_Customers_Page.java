...
public class Show_Customers_Page extends JFrame {
	...
	protected static final Component Show_Customers_Page = null;
		...
		btnDelete.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				for (int i = 0; i < selected_rows.length; i++) {
					try {
						showcontroller.Delete((int) table.getValueAt(selected_rows[i]-1, 0));
						model.removeRow(selected_rows[i]-i);
						JOptionPane.showMessageDialog(btnDelete, "Customer Deleted!");
					} catch (SQLException e1) {
						// TODO Auto-generated catch block
						e1.printStackTrace();
					}
